...
export class Initial1636818738380 implements MigrationInterface {
  name = 'Initial1636818738380';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE \`component\`
                             (
                               \`id\`        int                                                                                                                                           NOT NULL AUTO_INCREMENT,
                               \`type\`      enum ('last', 'heel', 'sole', 'productionInsole', 'finishInsole', 'backCounter', 'laces', 'frontlet', 'lining', 'zip', 'leather', 'ornament') NULL,
                               \`name\`      varchar(255)                                                                                                                                  NOT NULL,
                               \`amount\`    int                                                                                                                                           NULL,
                               \`colorId\`   int                                                                                                                                           NULL,
                               \`ownerId\`   int                                                                                                                                           NULL,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`shoe_model_components_component\`
      DROP FOREIGN KEY \`FK_1a27e16ae0b9949c17c3f910531\``);
    await queryRunner.query(`ALTER TABLE \`shoe_model_components_component\`
      DROP FOREIGN KEY \`FK_e545d340c795a9c15e1e3661f7c\``);
    await queryRunner.query(`ALTER TABLE \`shoe_model\`
      DROP FOREIGN KEY \`FK_3d1347ae5112b0039779c728744\``);
    await queryRunner.query(`ALTER TABLE \`component\`
      DROP FOREIGN KEY \`FK_579e3e277e001f4e837cdf406e8\``);
    await queryRunner.query(`ALTER TABLE \`component\`
      DROP FOREIGN KEY \`FK_1065b1dce9ca0df62f703235eb4\``);
    await queryRunner.query(`ALTER TABLE \`color\`
